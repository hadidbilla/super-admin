...
// General Styles
const generalStyles = [
  "transition duration-200 border shadow-sm inline-flex items-center justify-center uppercase leading-6 text-xs lg:text-[13px] py-2 px-[18px] rounded-md font-medium cursor-pointer tracking-wider", // Default
  "focus:ring-2 focus:ring-primary focus:ring-opacity-20", // On focus
