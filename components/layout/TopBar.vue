...
<template>
  <div class="sticky top-0 z-40 lg:mx-auto lg:px-8">
    <div
      ...
      <button type="button" class="-m-2.5 p-2.5 text-gray-700 lg:hidden" @click="handleIsSidebarOpen(true)">
          ...
          <Menu as="div" class="relative">
            <MenuButton class="-m-1.5 flex items-center p-1.5">
              ...
              <span class="hidden lg:flex lg:items-center">
                    ...
                    <Lucide icon="UsersIcon" class="ml-2 h-5 w-5 text-gray-400" aria-hidden="true"/>
                  </span>
            </MenuButton>
