      ...
      >
        ...
        >
          <a
            ...
            :key="item.name"
            :href="item.href"
            :class="item.current ? 'text-primary' : 'text-gray-700'"
            >{{ item.name }}</a
          >
        </div>
        <Button
          variant="primary"
          href="#"
          class="ml-auto flex items-center gap-x-1 rounded-md"
        >
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
        <div class="flex items-center justify-between">
          ...
          <Button variant="primary" href="#" class=""
            >View all<span class="sr-only">, clients</span></Button
          >
        </div>
        <ul
          role="list"
